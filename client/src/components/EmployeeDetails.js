...
import { addEmpData, getEmployeeData, isAuthenticated } from '../helper';
    ...
    return(
        <div className="d-flex flex-column flex-md-row justify-content-between" style={{borderBottom:"1px solid lightgray"}}>
            <div className="d-flex align-items-center justify-content-start m-2 p-2">
               ...
               <div >
                  <select class="form-select" aria-label="Default select example">
                    <option selected>Active Employee</option>
            ...
            <div className="m-2 d-flex align-items-center justify-content-around">
                <Link className="btn btn-success text-white" style={{marginRight:"10px"}} to="/employeeinfo"><AddIcon />New</Link>
...
const TableCustomers = ({empDetails}) => {
    return(
        ...
        <div className="addcustomers d-flex flex-row">
          ...
          <div className="d-flex flex-row align-items-center justify-content-end ">
                ...
                <div>
                    <NavCustomer />
                   {
                       empDetails.length != 0 ? ( <TableCustomers empDetails={empDetails} />):(<h1>loading data ...</h1>)
                   }
