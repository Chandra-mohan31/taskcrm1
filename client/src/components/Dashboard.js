        ...
        return (
          ...
          <h1 className="text-primary p-2">Argon</h1>
                    ...
                    signout(()=>{
                       ...
                       <div className="topbar py-2 d-none d-md-flex flex-row align-items-center justify-content-between">
                            <a href="#" className="link-light mx-2" style={{textDecoration: "none"}}>DASHBOARD</a>
                            <div className="d-flex">
                            <div className="inputcontainer d-flex flex-row align-items-center justify-content-start">
                            <SearchIcon />
                            <input type="text" style={{width:"300px"}} placeholder="search" className="inputholder" value={text} onChange={e => setText(e.target.value)} />
                            </div>
            ...
            <StatsCard Icon={PieChartRoundedIcon} bgcolor="yellow" title="SALES" val="924"  />
            ...
            <div style={{backgroundColor:"#f8f9fe",padding:"20px"}}>
                <PageMain />
            </div>
